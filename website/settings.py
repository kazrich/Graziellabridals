...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # ✅ Add it here
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # ← This is the line you're editing
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.user_profile',  # 👈 Add this line
            ],
        },
    },
]
...
EMAIL_HOST_PASSWORD = 'aets wwjw pydn fvqa'  # use an App Password, not your Gmail password
